...
class InstagramAuthenticationController extends Controller
{
    public function indexAction(Request $request)
    {
        $instagram = new Instagram(array(
            'apiKey'      => $this->container->getParameter('ssmf_instagram_client_id'),
            'apiSecret'   => $this->container->getParameter('ssmf_instagram_client_secret'),
            'apiCallback' => $this->container->getParameter('ssmf_instagram_callback')
        ));
